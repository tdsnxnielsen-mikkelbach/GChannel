...
| 12. Remaining stable `v1` surface | §12.1–12.3 implemented; §12.4 proposed | [todos/12-remaining-v1-surface.md](todos/12-remaining-v1-surface.md) |
...
| 4 — Billing export (BigQuery) | Deferred (out of Channel API) |
